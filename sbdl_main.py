...
from MDM_Pipline_To_System_Analysis.lib import ConfigLoader, Utils, DataLoader, Transformation
from MDM_Pipline_To_System_Analysis.lib.logger import  Log4j
...
if __name__ == '__main__':
    ...
    # This is the output that I am sending to Kafka
    # Kafka takes a key value pair
    # To send a dataframe to Kafka it has to be a 2 column dataframe
    ...
    # Take the final df and convert it into a key value dataframe
    # I use the json function to send it to kafka as json
...
# To send the data we must have a Kafka cluster
